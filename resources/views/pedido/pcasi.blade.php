...
$(document).ready(function() {
  ...
  <li class="nav-item"> <a class="nav-link active" href="/pedido/pcasi"> Casillero</a></li>
...
<select style="width:100%;" id="comer4" name="comer4" class="form-control mi-selector" required tabindex="1" autofocus required multiple="multiple">
      ...
      <option value="Casillero centro logístico">Casillero centro logístico</option>
              ...
              <div class="col-12 ">
                <div class="row g-3 justify-content-end">
                  <div class="col-auto">
                  <a href="/pedido/pcasi">   <button class="btn btn-phoenix-primary px-5" tabindex="14">Cancelar</button></a>
                  </div>
                  <div class="col-auto">
