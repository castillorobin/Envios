...
$(document).ready(function() {
  ...
  <li class="nav-item"> <a class="nav-link active" href="/pedido/pfijo"> Punto fijo</a></li>
...
<div class="tab-pane fade " id="tab-depa" role="tabpanel" aria-labelledby="depa-tab">
  ...
  <div class="p-3 rounded">
                    ...
                    <div class="col-xl-12">
                    <form action="/pedido/puntof" method="GET" id="myForm" class="row g-3 mb-12" >
    @csrf
      ...
      <option value="Casillero centro logístico">Casillero centro logístico</option>
              ...
              <div class="col-12 ">
                <div class="row g-3 justify-content-end">
                  <div class="col-auto">
                  <a href="/pedido/pefijo">   <button class="btn btn-phoenix-primary px-5" tabindex="14">Cancelar</button></a>
                  </div>
                  <div class="col-auto">
