...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Editar Recolecta</h3>
        </div>
  ...
  $("select").focusout(function() {
    ...
    */
    console.log('Este campo es obligatorio');
      ...
      <form action="/recolecta/{{$recolecta->id}}" method="POST" id="myForm">
    @csrf
    @method('PUT')
    <div class="row mx-5" >
    ...
    <div class="col-sm-10">
        ...
        <div class="input-group mb-3">
                ...
                <select id="nombre" name="nombre" class="form-control" tabindex="1" required>
                    <option value="{{$recolecta->nombre}}" selected >{{$recolecta->nombre}}r</option>
...
<div class="col-sm-2 pt-5" >
  ...
  <input hidden type="text" id="nombre2" name="nombre2" value="{{$recolecta->nombre}}">
<div class="col-sm-12 ">
...
<option value="{{$recolecta->repartidor}}">{{$recolecta->repartidor}}</option>
...
<option value="{{$recolecta->estado}}" selected >{{$recolecta->estado}}</option>
...
<option value="{{$recolecta->agencia}}" selected >{{$recolecta->agencia}}r</option>
