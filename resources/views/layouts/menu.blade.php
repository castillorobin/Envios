        ...
        <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              <li class="nav-item">
                <!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="/home" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-home">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav parent collapse" data-bs-parent="#navbarVerticalCollapse" id="nv-project-management" style="">
                      ...
                      <li class="nav-item"><a class="nav-link" href="/pedido/crearp" data-bs-toggle="" aria-expanded="false">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Crer pedido</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                      </li>
                      ...
                      <li class="nav-item"><a class="nav-link" href=="/pedido/crearpf" data-bs-toggle="" aria-expanded="false">
